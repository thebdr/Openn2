...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "ph_reporting":      {"en": "Reporting", "it": "Report"},
    ...
    "pb_fill_iolist":       {"en": "Fill I/O List", "it": "Compila I/O List"},
    "pb_stage_iolist":      {"en": "Stage I/O List", "it": "Stage I/O List"},
    ...
    "pb_gen_diag_blocks":   {"en": "Generate Diag Blocks", "it": "Genera Diag Blocks"},
    "pb_gen_stations":      {"en": "Generate Stations", "it": "Genera Stazioni"},
    "pb_gen_modules":       {"en": "Generate Modules", "it": "Genera Moduli"},
    "pb_gen_blocks":        {"en": "Generate Blocks", "it": "Genera Blocchi"},
    "pb_gen_instances":     {"en": "Generate Instances", "it": "Genera Istanze"},
    "pb_gen_shells":        {"en": "Generate Empty Shells .xlsm", "it": "Genera Shell Vuoti .xlsm"},
    "pb_gen_cov_p2":        {"en": "Generate Pipeline2 Coverage Report", "it": "Genera Report Copertura Pipeline2"},
    "pb_gen_cov_tia":       {"en": "Generate Tia Portal Project Coverage Report", "it": "Genera Report Copertura Progetto Tia Portal"},
    # --- phase bar: open buttons --------------------------------------------- #
    ...
    "pb_open_val_logs":     {"en": "Validation Logs Folder", "it": "Cartella Log Validazione"},
    "pb_open_fill_config":  {"en": "Open Fill Config .csv", "it": "Apri Config Compilazione .csv"},
    ...
    "pb_open_interfaces":   {"en": "Open Interfaces Folder", "it": "Cartella Interfacce"},
    "pb_open_io_tags":      {"en": "Open IO Tags", "it": "Apri IO Tags"},
    "pb_open_data_blocks":  {"en": "Open Data Blocks Folder", "it": "Cartella Data Blocks"},
    "pb_open_diag_data":    {"en": "Open Diag Data Folder", "it": "Cartella Diag Data"},
    "pb_open_diag_config":  {"en": "Open Diag Config .csv Folder", "it": "Cartella Config Diag .csv"},
    "pb_open_hardware":     {"en": "Open Hardware Data Folder", "it": "Cartella Dati Hardware"},
    "pb_open_shells":       {"en": "Open Empty Shells .xlsm", "it": "Apri Shell Vuoti .xlsm"},
    "pb_open_reports":      {"en": "Open Reports Folder", "it": "Cartella Report"},
    "pb_coming_soon":       {"en": "not implemented yet", "it": "non ancora implementato"},
