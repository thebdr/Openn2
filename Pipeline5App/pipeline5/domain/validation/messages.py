...
MESSAGES = {
    ...
    "pp_empty": {"en": "Empty mandatory permanent part for row with TYPE=A/W", "it": "Parte permanente obbligatoria per riga con TYPE=A/W vuota"},
    "pp_unknown": {"en": "Unknown mandatory permanent part '{value}' for row with TYPE=A/W", "it": "Parte permanente sconosciuta '{value}' per riga con TYPE=A/W"},
