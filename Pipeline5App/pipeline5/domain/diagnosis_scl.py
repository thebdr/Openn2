...
from pipeline5.domain.diagnosis_builder import _int_or_none
from pipeline5.domain.diagnosis_schema import diagnosis_cabinets_table, diagnosis_entries_table
