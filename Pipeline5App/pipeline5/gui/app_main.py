...
from pipeline5.gui.database_explorer import DatabaseExplorer
from pipeline5.gui.files_panel import FilesPanel
from pipeline5.gui.findings_panel import FindingsPanel
from pipeline5.gui.documents_panel import DocumentsPanel
from pipeline5.gui.log_view import LogView
from pipeline5.gui.phasebar import PhaseBar
...
class App:
    def __init__(self, root):
        ...
        from pipeline5.gui.chasebar import ChaseBar
        ...
        from pipeline5.gui import darktitle
    ...
    def _project_new(self):
        ...
        from pipeline5.gui.new_project import NewProjectDialog
    ...
    def _run_validation(self, only=None):
        ...
        from pipeline5.domain.validation import messages
                                                 phase as validation)
        if only is None:
            from pipeline5.io import report_renderer as iorender
    ...
    def _open_expr_builder(self):
        ...
        from pipeline5.gui.expr_builder import ExprBuilder
