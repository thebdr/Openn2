...
def _cols(document: str) -> dict:
    """canonical -> column letter for a document, from config/column_map.csv."""
...
def main():
    from safetydb import staging, validation
    ...
    print(f"  -> {os.path.join(out_dir, 'validation_log.txt')}  +  validation_log.html")
